...
public class SignDocument {
    ...
    String offerUniqueID = "ETONUMCONTRACT";                    //ICCProfile.pyFileSource
    boolean isNeedQualificationsBorder = true;

    String fileInput = "Doc1.pdf";
...
////oLog.debug("srcDocumentStream=" + srcDocumentStream);
...
//        oLog.debug("OfferUniqueID=" + offerUniqueID);
//
...
//            com.itextpdf.text.Paragraph offerUniqeIDText = new com.itextpdf.text.Paragraph(offerUniqueID, dateFont);
...
//        trgDocumentStream = encoder.encodeToString(baos.toByteArray());
//-----------------
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
        java.io.ByteArrayOutputStream pdfaos = new java.io.ByteArrayOutputStream();
        com.itextpdf.text.pdf.PdfStamper stamper = null;
        ...
        try {
            ...
            com.itextpdf.text.Paragraph dateText = new com.itextpdf.text.Paragraph(dateStr, dateFont);
              com.itextpdf.text.Paragraph offerUniqeIDText = new com.itextpdf.text.Paragraph(offerUniqueID, dateFont);
            float offsetByDateSize = bf.getWidthPoint(dateStr, dateFontSize);
            float offsetByOfferUniqueIDSize = bf.getWidthPoint(offerUniqueID, dateFontSize);
